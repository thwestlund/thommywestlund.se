...
export const exp: Experience[] = [
  {
    ...
    bulletList: [
      ...
      "Driva kostnadsfrågr och opitmering av resurser i Azure.",
    ],
  },
  {
  ...
  },
  {
    ...
    bulletList: [
      ...
      "Medverka i korsfunktionella team för att diskutera och optimera processer över flera system och användargrupper.",
  ...
  },
  {
    ...
    bulletList: [
      ...
      "Rekonstruera av backlog i Azure DevOps baserat på User Stories och Scenarion som jag skapade.",
  ...
  },
  {
    ...
    bulletList: [
      ...
      "Ta fram nya en POCO-lösning med Linq2DB för att förbättra utvecklingsarbetet, samt minska på potentiella fel",
